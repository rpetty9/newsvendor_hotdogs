    ...
    *,
    ...
    ">
        ...
        ">
            ...
            <div style="flex:1; max-width:420px; padding:14px 16px; border-radius:14px; background:#FFFFFF; border:1px solid #E0E3EB; text-align:center;">
                <div style="font-size:12px; letter-spacing:0.12em; color:#6B7280; font-weight:800;">{left_label}</div>
                <div style="font-size:30px; font-weight:950; color:#111827; margin-top:2px;">{left_value}</div>
            </div>

            <div style="min-width:66px; display:flex; align-items:center; justify-content:center; flex-direction:column;">
                <div style="font-size:12px; letter-spacing:0.16em; color:#9CA3AF; font-weight:900; text-align:center;">VS</div>
                <div style="margin-top:4px; width:36px; height:2px; border-radius:999px; background:#E0E3EB;"></div>
            </div>

            <div style="flex:1; max-width:420px; padding:14px 16px; border-radius:14px; background:#FFFFFF; border:1px solid #E0E3EB; text-align:center;">
                <div style="font-size:12px; letter-spacing:0.12em; color:#6B7280; font-weight:800;">{right_label}</div>
                <div style="font-size:30px; font-weight:950; color:#111827; margin-top:2px;">{right_value}</div>
            </div>
            </div>
